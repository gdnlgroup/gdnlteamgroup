...
add_post_type_support( 'projet', 'post-formats' );
 
require_once(ABSPATH.'wp-content/themes/twentyeleven/types/projet.php');
require_once(ABSPATH.'wp-content/themes/twentyeleven/types/publication.php');
require_once(ABSPATH.'wp-content/themes/twentyeleven/types/document.php');
require_once(ABSPATH.'wp-content/themes/twentyeleven/types/icones.php');
...
function twentyeleven_posted_on() {
	printf( __( '<span class="sep">Posted on </span><a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s" pubdate>%4$s</time></a><span class="by-author"> <span class="sep"> by </span> <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span></span>', 'twentyeleven' ),
        ...
        echo '<a href="mailto:abocoum@hotmail.fr">contact</a>';
}
endif;
