...
<div   margin-left: 10%; ">
	...
	<fieldset style="border:groove; width: 50%; margin-left: 10%; margin-bottom: 1%;">
		<a href="javascript:void(0);" onclick="pmSwitch('pm-send');">Nouveau Message</a> | <a href="javascript:void(0);" onclick="pmSwitch('pm-inbox');">Boite de reception</a> | <a href="javascript:void(0);" onclick="pmSwitch('pm-outbox');">Messages Envoy&eacute;s</a>
	</fieldset>
