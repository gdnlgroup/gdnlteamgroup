<?php 
require_once(ABSPATH.'wp-content/themes/evolve/types/projet.php');
require_once(ABSPATH.'wp-content/themes/evolve/types/publication.php');
require_once(ABSPATH.'wp-content/themes/evolve/types/document.php');
require_once(ABSPATH.'wp-content/themes/evolve/types/icones.php');
...
<a href="http://theme4press.com/evolve-pro/" target="_blank"><img style="margin-bottom:20px;float:left;position:relative;top:10px;" width="828" height="130" border="0" alt="Theme4Press Themes" src="<?php echo get_template_directory_uri(); ?>/library/media/images/t4p-themes.jpg"></a>
		...
		<?php echo '<div id="message" class="updated fade" style="float:left;"><p><strong>'.$evlthemename.' settings saved</strong></p></div>'; ?>
    
    <?php } if( isset( $_REQUEST['reset'] )) { echo '<div id="message" class="updated fade"><p><strong>'.$evlthemename.' settings reset</strong></p></div>'; } ?>  
