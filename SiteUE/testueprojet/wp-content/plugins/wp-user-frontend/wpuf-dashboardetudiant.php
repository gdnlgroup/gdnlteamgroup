 ...
 */
function wpuf_user_dashboardetudiant( $atts ) {
    ...
    if ( is_user_logged_in() ) {
        wpuf_user_dashboard_post_listetudiant( $post_type );
    } else {
        Redirect_('login');
       die();
...
add_shortcode( 'wpuf_dashboardetudiant', 'wpuf_user_dashboardetudiant' );
 ...
 */
function wpuf_user_dashboard_post_listetudiant( $post_type ) {
