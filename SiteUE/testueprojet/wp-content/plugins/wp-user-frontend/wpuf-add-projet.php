 ...
 * @param $atts
 */
function wpuf_add_projet_shorcode( $atts ) {
...
add_shortcode( 'wpuf_addprojet', 'wpuf_add_projet_shorcode' );
 ...
 * @param $post_type
 */
function wpuf_add_projet( $post_type ) {
    global $userdata;
...
function wpuf_init_projet_check() {
 ...
 */
function wpuf_validate_projet_submit() {
    global $userdata;
