...
require_once 'wpuf-dash-attente.php';
require_once 'wpuf-dashboardetudiant.php';
require_once 'wpuf-add-post.php';
require_once 'wpuf-add-message.php';
require_once 'wpuf-pending-post.php';
require_once 'wpuf-add-projet.php';
