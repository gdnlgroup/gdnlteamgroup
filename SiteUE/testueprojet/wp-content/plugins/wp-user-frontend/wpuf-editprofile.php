...
add_action( 'show_user_profile', 'wpuf_add_post_lock' );
add_action( 'edit_user_profile', 'wpuf_add_post_lock' );
 ...
 * @param type $user_id
 */
function wpuf_add_post_update( $user_id ) {
    if ( is_admin() && current_user_can( 'edit_users' ) ) {
...
add_action( 'personal_options_update', 'wpuf_add_post_update' );
add_action( 'edit_user_profile_update', 'wpuf_add_post_update' );
