...
function mt_add_page_raz() {
	...
	//htmlentities()
    add_menu_page(__('Remise à zéro','gestion-utilisateurs'), __('Remise a zero','gestion-utilisateurs'), 'edit_users', 'mt-top-level-handle_raz', 'mt_toplevel_page_raz',plugins_url('raz/images/cross-button.png') );
}
